...
/* ONE copy of the sample codec, browser walk and transfer, shared with the
 * chain UI. Relative on purpose — see the header of sample_io.mjs. */
import {
    SAMPLE_LIMIT, b64ToBytes, parseWav, sendSample, listSamples, sampleDisplayName
} from './sample_io.mjs';
...
function loadSampleFile(path, quiet) {
    ...
    const sent = sendSample(setParam, name, wav, maxFrames);
